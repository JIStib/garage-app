...
import type { StatsMontantTotal } from "../../types";

export default function InterventionsStatsMontants() {
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
            ...
            <div className="flex items-end justify-between mt-5">
              <div>
                <span className="text-sm text-gray-500 dark:text-gray-400">
                  Créées : <b>{montantCreees?.count || 0}</b>
                </span>
                {loading ? (
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
            ...
            <div className="flex items-end justify-between mt-5">
              <div>
                <span className="text-sm text-gray-500 dark:text-gray-400">
                  Payées : <b>{montantPayees?.count || 0}</b>
                </span>
                {loading ? (
                  <div className="mt-5 flex items-center gap-2">
                    <div className="h-5 w-5 border-2 border-white/20 border-t-brand-500 rounded-full animate-spin" />
